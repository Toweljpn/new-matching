document.addEventListener('DOMContentLoaded', () => {
    ...
    const resultsData = {
        ...
        //    categories: [{ name: '匠の技（ひな）', img: 'https://placehold.co/280x280/c2a890/FFFFFF?text=Hina+Storage' }, { name: '本物志向（ひな）', img: 'https://placehold.co/280x280/c2a890/FFFFFF?text=Hina+Chair' }],
            categories: [{ name: '匠の技（ひな）', img: './images/001-1.webp' }, { name: '本物志向（ひな）', img: './images/001-2.webp' }],
        ...
        //    categories: [{ name: 'リビング収納 (ひな)', img: 'https://placehold.co/280x280/c2a890/FFFFFF?text=Hina+Storage' }, { name: 'コンパクト収納 (ひな)', img: 'https://placehold.co/280x280/c2a890/FFFFFF?text=Hina+Chair' }],
            categories: [{ name: 'リビング収納 (ひな)', img: './images/002-1.webp' }, { name: 'コンパクト収納 (ひな)', img: './images/002-2.webp' }],
        ...
        //    categories: [{ name: '家族で納得 （ひな)', img: 'https://placehold.co/280x280/c2a890/FFFFFF?text=Hina+Storage' }, { name: '伝統美 (ひな)', img: 'https://placehold.co/280x280/c2a890/FFFFFF?text=Hina+Chair' }],
            categories: [{ name: '家族で納得 （ひな)', img: './images/003-1.webp' }, { name: '伝統美 (ひな)', img: './images/003-2.webp' }],
        ...
        //    categories: [{ name: 'モダン (ひな)', img: 'https://placehold.co/280x280/c2a890/FFFFFF?text=Hina+Shelf' }, { name: 'スタイリッシュ (ひな)', img: 'https://placehold.co/280x280/c2a890/FFFFFF?text=Hina+Desk' }],
            categories: [{ name: 'モダン (ひな)', img: './images/004-1.webp' }, { name: 'スタイリッシュ (ひな)', img: './images/004-2.webp' }],
        ...
        //    message: 'コンパクトさと現代的なデザイン性を最優先するお客様の価値観を反映。節句人形をインテリアの一部として捉える、新しい楽しみ方を提案します。 ',
            message: 'コンパクトさと現代的なデザイン性を最優先するお客様の価値観を反映。節句人形をインテリアの一部として捉える、新しい楽しみ方を提案します。 ',
            categories: [{ name: '現代的デザイン (ひな)', img: './images/005-1.webp' }, { name: 'インテリアの一部 (ひな)', img: './images/005-2.webp' }],
        ...
        //    categories: [{ name: 'おしゃれ (ひな)', img: 'https://placehold.co/280x280/c2a890/FFFFFF?text=Hina+Shelf' }, { name: '調和 (ひな)', img: 'https://placehold.co/280x280/c2a890/FFFFFF?text=Hina+Desk' }],
            categories: [{ name: 'おしゃれ (ひな)', img: './images/006-1.webp' }, { name: '調和 (ひな)', img: './images/006-2.webp' }],
        ...
        //    categories: [{ name: '可愛らしさ (ひな)', img: 'https://placehold.co/280x280/c2a890/FFFFFF?text=Hina+Box' }, { name: '格式と品質 (ひな)', img: 'https://placehold.co/280x280/c2a890/FFFFFF?text=Hina+Stool' }],
            categories: [{ name: '可愛らしさ (ひな)', img: './images/007-1.webp' }, { name: '格式と品質 (ひな)', img: './images/007-2.webp' }],
        ...
        //    categories: [{ name: '心和む (ひな)', img: 'https://placehold.co/280x280/c2a890/FFFFFF?text=Hina+Box' }, { name: 'わが子に似合う (ひな)', img: 'https://placehold.co/280x280/c2a890/FFFFFF?text=Hina+Stool' }],
            categories: [{ name: '心和む (ひな)', img: './images/008-1.webp' }, { name: 'わが子に似合う (ひな)', img: './images/008-2.webp' }],
        ...
        //    categories: [{ name: 'コンパクト (ひな)', img: 'https://placehold.co/280x280/c2a890/FFFFFF?text=Hina+Box' }, { name: '現代的 (ひな)', img: 'https://placehold.co/280x280/c2a890/FFFFFF?text=Hina+Stool' }],
            categories: [{ name: 'コンパクト (ひな)', img: './images/009-1.webp' }, { name: '現代的 (ひな)', img: './images/009-2.webp' }],
        ...
        'hina_standard_natural_elegant_function': {
            ...
            categories: [{ name: '家の誇り (ひな)', img: './images/010-1.webp' }, { name: '本格的 (ひな)', img: './images/010-2.webp' }],
        ...
        'hina_standard_natural_elegant_design': {
            ...
            categories: [{ name: '美しい佇まい (ひな)', img: './images/011-1.webp' }, { name: '節句の王道 (ひな)', img: './images/011-2.webp' }],
        ...
        'hina_standard_natural_elegant_balance': {
            ...
            categories: [{ name: '調和が大切 (ひな)', img: './images/012-1.webp' }, { name: '伝統的 (ひな)', img: './images/012-2.webp' }],
        ...
        'hina_standard_modern_stylish_function': {
            ...
            categories: [{ name: 'サイズ感 (ひな)', img: './images/013-1.webp' }, { name: '伝統と革新 (ひな)', img: './images/013-2.webp' }],
        ...
        'hina_standard_modern_stylish_design': {
            ...
            categories: [{ name: '優雅 (ひな)', img: './images/014-1.webp' }, { name: 'インテリア (ひな)', img: './images/014-2.webp' }],
        ...
        'hina_standard_modern_stylish_balance': {
            ...
            categories: [{ name: '新しいお祝い (ひな)', img: './images/015-1.webp' }, { name: '家族像 (ひな)', img: './images/015-2.webp' }],
        ...
        'hina_standard_playful_cheerful_function': {
            ...
            categories: [{ name: 'こだわりの逸品 (ひな)', img: './images/016-1.webp' }, { name: '本物の気品 (ひな)', img: './images/016-2.webp' }],
        ...
        'hina_standard_playful_cheerful_design': {
            ...
            categories: [{ name: '晴れやか (ひな)', img: './images/017-1.webp' }, { name: '優しい雰囲気 (ひな)', img: './images/017-2.webp' }],
        ...
        'hina_standard_playful_cheerful_balance': {
            ...
            categories: [{ name: '盛大なお祝い (ひな)', img: './images/018-1.webp' }, { name: '穏やかな表情 (ひな)', img: './images/018-2.webp' }],
        ...
        'hina_space_saving_natural_elegant_function': {
            ...
            categories: [{ name: '格式高い (ひな)', img: './images/019-1.webp' }, { name: '合理的収納 (ひな)', img: './images/019-2.webp' }],
        ...
        'hina_space_saving_natural_elegant_design': {
            ...
            categories: [{ name: 'スマートな選択 (ひな)', img: './images/020-1.webp' }, { name: '賢くしまう (ひな)', img: './images/020-2.webp' }],
        ...
        'hina_space_saving_natural_elegant_balance': {
            ...
            categories: [{ name: '実用的ニーズ (ひな)', img: './images/021-1.webp' }, { name: '伝統美 (ひな)', img: './images/021-1.webp' }],
        ...
        'hina_space_saving_modern_stylish_function': {
            ...
            categories: [{ name: '利便性 (ひな)', img: './images/022-1.webp' }, { name: '機能性を極めた (ひな)', img: './images/022-2.webp' }],
        ...
        'hina_space_saving_modern_stylish_design': {
            ...
            categories: [{ name: '暮らしにフィット (ひな)', img: './images/023-1.webp' }, { name: '収納優先 (ひな)', img: './images/023-2.webp' }],
        ...
        'hina_space_saving_modern_stylish_balance': {
            ...
            categories: [{ name: 'おしゃれ収納 (ひな)', img: './images/024-1.webp' }, { name: 'スマート収納 (ひな)', img: './images/024-2.webp' }],
        ...
        'hina_space_saving_playful_cheerful_function': {
            ...
            categories: [{ name: '名匠の収納 (ひな)', img: './images/025-1.webp' }, { name: '愛情収納 (ひな)', img: './images/025-2.webp' }],
        ...
        'hina_space_saving_playful_cheerful_design': {
            ...
            categories: [{ name: '楽しい片付け (ひな)', img: './images/026-1.webp' }, { name: '収納の利便性 (ひな)', img: './images/026-2.webp' }],
        ...
        'hina_space_saving_playful_cheerful_balance': {
            ...
            categories: [{ name: '手軽に収納 (ひな)', img: './images/027-1.webp' }, { name: '最も簡単 (ひな)', img: './images/027-2.webp' }],
        ...
        'gogatsu_compact_natural_elegant_function': {
            ...
            categories: [{ name: '匠の技 (五月)', img: './images/028-1.webp' }, { name: 'コンパクト兜 (五月)', img: './images/028-2.webp' }],
        ...
        'gogatsu_compact_natural_elegant_design': {
            ...
            categories: [{ name: '造形美 (五月)', img: './images/029-1.webp' }, { name: '知的好奇心 (五月)', img: './images/029-2.webp' }],
        ...
        'gogatsu_compact_natural_elegant_balance': {
            ...
            categories: [{ name: 'バランス (五月)', img: './images/030-1.webp' }, { name: '伝統的でコンパクト (五月)', img: './images/030-2.webp' }],
        ...
        'gogatsu_compact_modern_stylish_function': {
            ...
            categories: [{ name: 'モダン (五月)', img: './images/031-1.webp' }, { name: '精緻な作り (五月)', img: './images/031-2.webp' }],
        ...
        'gogatsu_compact_modern_stylish_design': {
            ...
            categories: [{ name: 'インテリア飾り (五月)', img: './images/032-1.webp' }, { name: '美しい工芸品 (五月)', img: './images/032-2.webp' }],
        ...
        'gogatsu_compact_modern_stylish_balance': {
            ...
            categories: [{ name: 'おしゃれ (五月)', img: './images/033-1.webp' }, { name: '現代的 (五月)', img: './images/033-2.webp' }],
        ...
        'gogatsu_compact_playful_cheerful_function': {
            ...
            categories: [{ name: '確かな技 (五月)', img: './images/034-1.webp' }, { name: '審美眼 (五月)', img: './images/034-2.webp' }],
        ...
        'gogatsu_compact_playful_cheerful_design': {
            ...
            categories: [{ name: '親しみやすさ (五月)', img: './images/035-1.webp' }, { name: '可愛らしさ (五月)', img: './images/035-2.webp' }],
        ...
        'gogatsu_compact_playful_cheerful_balance': {
            ...
            message: '家族全員が「かわいい」と共感でき、かつコンパクトで飾りやすいという、現代の家族のニーズに最も寄り添ったバランスの良いスタイルです。 ',
            categories: [{ name: '家族全員で (五月)', img: './images/036-1.webp' }, { name: '現代の家族に (五月)', img: './images/036-2.webp' }],
        ...
        'gogatsu_standard_natural_elegant_function': {
            ...
            categories: [{ name: '格式高い (五月)', img: './images/037-1.webp' }, { name: '家宝としての価値 (五月)', img: './images/037-2.webp' }],
        ...
        'gogatsu_standard_natural_elegant_design': {
            ...
            categories: [{ name: '王道鎧 (五月)', img: './images/038-1.webp' }, { name: '造形美 (五月)', img: './images/038-2.webp' }],
        ...
        'gogatsu_standard_natural_elegant_balance': {
            ...
            message: '家族での調和を大切にしながら、本格的で伝統的なお祝いをしたいという想いを反映。世代を超えて愛される普遍的な美しさを提案します。 ',
            categories: [{ name: '家族の調和 (五月)', img: './images/039-1.webp' }, { name: '普遍的な美 (五月)', img: './images/039-2.webp' }],
        ...
        'gogatsu_standard_modern_stylish_function': {
            ...
            message: '本格的なサイズ感の中に、現代的なデザイン要素を求めるお客様向け。作家の新しい挑戦や感性を楽しむ、通好みのスタイルです。',
            categories: [{ name: '本格サイズ (五月)', img: './images/040-1.webp' }, { name: 'デザイン重視 (五月)', img: './images/040-2.webp' }],
        ...
        'gogatsu_standard_modern_stylish_design': {
            ...
            categories: [{ name: '空間オブジェ (五月)', img: './images/041-1.webp' }, { name: 'インテリア (五月)', img: './images/041-2.webp' }],
        ...
        'gogatsu_standard_modern_stylish_balance': {
            ...
            message: '家族みんなの意見を取り入れながら、伝統にとらわれない新しいお祝いの形を模索する、現代的な家族像を反映したスタイルです。 ',
            categories: [{ name: '家族みんなで (五月)', img: './images/042-1.webp' }, { name: '現代の家族 (五月)', img: './images/042-2.webp' }],
            advice: '屏風のデザインを家族で選ぶのも「フリープラン」の醍醐味です。 '
        },
        ...
        'gogatsu_standard_playful_cheerful_function': {
            ...
            categories: [{ name: '可愛い大将 (五月)', img: './images/043-1.webp' }, { name: '飾り映え (五月)', img: './images/043-2.webp' }],
            advice: '鯉のぼりの室内飾りを脇に添えると、より賑やかになります。 '
        },
        // 44
        'gogatsu_standard_playful_cheerful_design': {
            ...
            message: 'お人形の「かわいい」表情や雰囲気を何よりも大切にしたいという、お子様への愛情が伝わるピュアな想いを反映したスタイルです。 ',
            categories: [{ name: '可愛い雰囲気 (五月)', img: './images/044-1.webp' }, { name: 'お子様への愛情 (五月)', img: './images/044-2.webp' }],
        ...
        'gogatsu_standard_playful_cheerful_balance': {
            ...
            message: '家族全員が「かわいい」と心から思えることを大切にしつつ、本格的な飾りで盛大にお祝いしたいという想いを形にしたスタイルです。',
            categories: [{ name: '本格的 (五月)', img: './images/045-1.webp' }, { name: '盛大なお祝い (五月)', img: './images/045-2.webp' }],
            advice: 'お子様と一緒に飾り付けができる、安全で軽いお道具もございます。 '
        },
        ...
        'gogatsu_space_saving_natural_elegant_function': {
            ...
            message: '格式高い作家物を求めつつも、収納の利便性は譲れないという、非常に賢明で現代的なニーズに応える、最も合理的な本格派スタイルです。',
            categories: [{ name: '収納の利便性 (五月)', img: './images/046-1.webp' }, { name: '現代的なニーズ (五月)', img: './images/046-2.webp' }],
            advice: '伝統的なお道具も全て収まるか、事前にサイズ確認をしましょう。 '
        },
        // 47
        'gogatsu_space_saving_natural_elegant_design': {
            ...
            message: '伝統的なデザインの美しさを楽しみながら、収納の手間は省きたいというお客様のニーズを的確に捉えた、スマートな選択です。 ',
            categories: [{ name: 'スマートな選択 (五月)', img: './images/047-1.webp' }, { name: '賢く収納 (五月)', img: './images/047-2.webp' }],
        ...
        'gogatsu_space_saving_natural_elegant_balance': {
            ...
            message: '伝統的な美しさを求めつつ、収納の手間を軽減したいという実用的なニーズと、家族での調和を大切にする想いを汲み取ったスタイルです。',
            categories: [{ name: 'オールインワン (五月)', img: './images/048-1.webp' }, { name: 'ワンパック収納 (五月)', img: './images/048-2.webp' }],
        ...
        'gogatsu_space_saving_modern_stylish_function': {
            ...
            message: 'モダンなデザインと作家物の品質、そして収納の利便性という、現代のニーズをすべて満たしたいと考える、最も要求レベルの高いお客様向けのスタイル。 ',
            categories: [{ name: '作家品質 (五月)', img: './images/049-1.webp' }, { name: '最高品質 (五月', img: './images/049-2.webp' }],
            advice: '飾り台の色とお部屋の家具の色を合わせると、統一感が出ます。'
        },
        // 50
        'gogatsu_space_saving_modern_stylish_design': {
            ...
            message: 'デザイン性と収納のしやすさを最優先するお客様に。節句の準備から後片付けまで、すべてのプロセスをスマートに楽しみたいという想いを反映します。',
            categories: [{ name: '暮らしにフィット (五月)', img: './images/050-1.webp' }, { name: 'デザイン収納 (五月)', img: './images/050-1.webp' }],
            advice: '屏風のデザインにこだわると、よりインテリア性が高まります。 '
        },
        // 51
        'gogatsu_space_saving_modern_stylish_balance': {
            ...
            message: '家族みんなが「おしゃれで、しかも片付けが楽」と納得できる、最もバランスの取れた現代的な選択。デザインと実用性の両方を満たします。',
            categories: [{ name: 'おしゃれ (五月)', img: './images/051-1.webp' }, { name: '実用性 (五月)', img: './images/051-2.webp' }],
            advice: 'お子様が自分でしまえるような、軽いお道具を選ぶのも良いですね。 '
        },
        ...
        'gogatsu_space_saving_playful_cheerful_function': {
            ...
            categories: [{ name: '確かな品質 (五月)', img: './images/052-1.webp' }, { name: '愛情と賢さ (五月)', img: './images/052-2.webp' }],
        ...
        'gogatsu_space_saving_playful_cheerful_design': {
            ...
            categories: [{ name: '可愛く便利 (五月)', img: './images/053-1.webp' }, { name: 'お子様と一緒に (五月)', img: './images/053-2.webp' }],
            advice: '飾り付けの場所を示すシールを箱に貼っておくと、翌年迷いません。 '
        },
        // 54
        'gogatsu_space_saving_playful_cheerful_balance': {
            ...
            message: '家族全員が「かわいい」と共感でき、かつ収納も簡単という、最も手軽で現代のライフスタイルに合った、みんなが笑顔になるスタイルです。',
            categories: [{ name: '家族みんなで (五月)', img: './images/054-1.webp' }, { name: '最も手軽 (五月)', img: './images/054-2.webp' }],
            advice: '毎年出すのが楽しみになるよう、家族の思い出の品を一緒に飾っては？ '
        }
        // --- 編集箇所：ここまで ---
    };
